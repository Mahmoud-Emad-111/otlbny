                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            {{-- <div class="col">
                                                <a href="{{ route('client.edit', $client) }}" class="btn btn-success btn-circle btn-sm">
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                </a>
                                            </div>
                                            <div class="col">
                                                <a href="{{ route('client.show', $client) }}" class="btn btn-info btn-circle btn-sm">
                                                    <i class="fa-solid fa-eye"></i>
                                                </a>
                                            </div> --}}
                                            <div class="col">
                                                <form id="FormDeleteTime" method="post" action="{{ route('Delete-user', $client->id) }}">
                                                    @csrf
