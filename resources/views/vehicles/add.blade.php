                        ...
                        <div class="col-lg-12 order-lg-1">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="/vehicle_instert" autocomplete="off">
                                        @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group focused">
                                                        <label class="form-control-label" for="name">Vehicle Name<span
                                                                class="small text-danger">*</span></label>
                                                        <input type="text" id="name" class="form-control" name="vehicle_name"
